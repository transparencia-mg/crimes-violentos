...
A documentação deste conjunto de dados está sendo feita de forma aberta e colaborativa no [Github](https://github.com///github). Existem duas alternativas para enviar sua contribuição:

- [Issues](https://github.com///github/issues): Para iniciar uma discussão sobre melhorias na documentação.
- [Pull requests](https://github.com///github/pulls): Para sugerir uma alteração concreta na documentação.
